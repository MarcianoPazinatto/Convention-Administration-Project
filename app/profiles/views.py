...
from app.profiles.actions import create as create_profile, \
    ...
    get_by_id_all_profile_in_the_same_coffe_room as get_by_id_all_profiles_coffe_rooms, delete_profiles,\
...
@app_profiles.route('/coffe-room/<id>/profiles', methods=['GET'])
def get_by_all_profiles_coffe_rooms(id: str) -> Tuple:
    all_profiles = get_by_id_all_profiles_coffe_rooms(id)
    return jsonify([profiles.serialize() for profiles in all_profiles]), 200
